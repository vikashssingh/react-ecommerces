...
export default function Footer() {
    ...
    return <footer className="footer">
        <div className="footer-top">
            ...
            <div className="footer-top-right">
                ...
                <div className="contact-lg">
                    <h3>CONTACT US</h3>
                    <p>+91: 95230❌❌179</p>
                    <p>vikashsinghs5530@gmail.com</p>
                </div>
        ...
        <div className="footer-bottom lg-footer-bottom">
            <div className="col" >
                <h3 style={{ fontSize: "20px", cursor:"pointer" }}>mettā muse</h3>
            ...
            <div className="col">
                ...
                <div className="social-media">
                    ...
                    <img src={linkedin} alt="logo" /> */}  
                      <a href="https://www.instagram.com/its_vkumar_vs/"><FaInstagram /></a> 
                    <a href="https://www.linkedin.com/in/im-vikashkumar/"><FaLinkedin /></a>
                    <FaTwitter/>
                    <IoLogoYoutube/>
        ...
        <div className="sm-footer-bottom">
            ...
            <section className="sm-payment-section">
                <h3 style={{ fontSize: "19px" }}>mettā muse ACCEPTS</h3>
